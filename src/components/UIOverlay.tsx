...
export const UIOverlay: React.FC<UIOverlayProps> = ({
  ...
  // Only show default presets if the current model is the original Eagle or UTDCampus
  const isPreset = currentBaseModel === 'Eagle' || currentBaseModel === 'UTDCampus';
      ...
      {isStable && (
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="pointer-events-auto animate-in zoom-in fade-in duration-500">
                    <button 
                        onClick={onDismantle}
                        className="group relative px-16 py-8 bg-rose-600 hover:bg-rose-500 text-white font-sans font-black text-5xl tracking-tighter uppercase transform hover:scale-105 active:scale-95 transition-all duration-200 shadow-[0_0_60px_rgba(225,29,72,0.6)] border-4 border-white skew-x-[-6deg]"
                    >
